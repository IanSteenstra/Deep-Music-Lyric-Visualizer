...
parser.add_argument("--class_picker", type=int, default=1)
...
# set ImageNet classes file
image_net_classes_file = args.image_net_classes_file

# initialize ImageNetClassPicker
image_net_class_picker = ImageNetClassPicker()
image_net_class_picker.load_imagenet_class_labels(image_net_classes_file)
...
# set how classes will be picked
class_picker = args.class_picker
...
if args.classes:
...
elif class_picker == 3:  # contextual similarity
    image_net_class_picker.load_song_lyrics(lyrics_file)
    ...
    semantic_classes_list = image_net_class_picker.get_classes_from_semantic_similarity(
        classes_per_lyric_line, 1000)
    print("List of classes determined based off contextual similarity:",
          semantic_classes_list)

    classes = []
    for class_id in semantic_classes_list:
        if class_id in sentiment_classes_list:
